...
/**
 * It represnts options buttons. (shown underneath question text).
 *
 * @author Mohammad.
 */
class OptionButton extends Label {
    ...
    /**
     * It is a constructor method creates a OptionButton object.
     */
    OptionButton() {
        super();
        setPrefSize(459, 77);
    ...
    /**
     * It changes the style (state) of an option button depending on the possible state value (see the static variables at the start of the class). (between -1 and 1)
     *
